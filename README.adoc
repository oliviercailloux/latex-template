= LaTeX coherent template: MegaTeX
...
(You will understand why I named it “MegaTeX” by looking at https://github.com/oliviercailloux/latex-template/blob/main/preamble/packages.tex[packages.tex].)
